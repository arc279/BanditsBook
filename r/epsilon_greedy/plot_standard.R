...
#library("data.table")
#results <- fread("../BanditsBook/python/algorithms/epsilon_greedy/standard_results.csv", sep="\t", header = FALSE)

results <- read.csv("../BanditsBook/python/algorithms/epsilon_greedy/standard_results.csv", header = FALSE)
...
#ggsave("standard_epsilon_greedy_variance_choices.pdf")
